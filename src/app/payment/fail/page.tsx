...
const Page = () => {
  return (
    <>
      <div className=' laptop:w-[950px] tablet:w-[300px] laptop:justify-between small:justify-center mx-auto mt-32 grid laptop:grid-cols-2 tablet:justify-center tablet:grid-cols-1'>
        <div>
